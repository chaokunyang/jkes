...
public class SearchClientException extends RuntimeException {
     ...
     * @since 1.4
     */
    public SearchClientException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public SearchClientException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
