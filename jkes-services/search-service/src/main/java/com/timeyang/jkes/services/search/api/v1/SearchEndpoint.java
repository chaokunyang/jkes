...
public class SearchEndpoint {
    ...
    public Map<String, Object> get(@PathVariable("index") String index,
                                   @PathVariable("type") String type,
                                   @PathVariable("id") String id) {
        return this.searchService.get(index, type, id);
    }

    @RequestMapping(value = "{index}/{type}/_search", method = {RequestMethod.GET, RequestMethod.POST})
    public ResponseProjection search(@PathVariable("index") String index,
                                     @PathVariable("type") String type,
